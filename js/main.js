...
var $hamburger = document.querySelector('.burger-js');
var $mainmenu = document.querySelector('.mainmenu--js'); // const $closeBtn = document.querySelector('.mainmenu--close')
...
enquire_js__WEBPACK_IMPORTED_MODULE_0___default().register('screen and (max-width: 1200px)', {
  // deferSetup: true,
...
var searchBtn = headerBottom.querySelector("[data-id='search']");
var catalogBtn = headerBottom.querySelector("[data-id='catalog']");
var searchCloseBtn = headerBottom.querySelector("[data-id='search-close-btn']");
...
headerBottom && headerBottom.addEventListener('mouseover', function (e) {
  var ta = e.target.closest("[data-id='submenu']");

  if (ta) {
    ta.classList.add('_active');
  }
});
headerBottom && headerBottom.addEventListener('mouseout', function (e) {
  var ta = e.target.closest("[data-id='submenu']");
...
var swiperDoors = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-door-js ', {
  slidesPerView: 'auto',
  breakpoints: {
    425: {
      slidesPerView: 2
  ...
  navigation: {// nextEl: '.before-services__btn_right',
...
var swiperReview = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.review__slider-js', {
  slidesPerView: 1,
  spaceBetween: 55,
  navigation: {
...
var detail = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.detail__slider-js', {
  slidesPerView: 1,
  spaceBetween: 55,
  navigation: {
...
var tabsColor = document.querySelector('.color-tabs-js');
var textColor = document.querySelector('.color-text-js');
tabsColor && tabsColor.addEventListener('click', function (e) {
  var color = e.target;
...
var modalOpenCallmeBtns = document.querySelectorAll('[data-id="callme"');
var modalCloseBtn = document.querySelector('.modal__close-js');
var modal = document.querySelector('.modal-js');
var stars = document.querySelectorAll("[data-id='stars']");
var title = modal.querySelector('.modal__title');
var submitBtn = modal.querySelector('[type="submit"]');

var generateStars = function generateStars(star) {
  star.innerHTML = '';
  var numStars = star.dataset.stars;
  var text = star.dataset.text || '';

  for (var i = 1; i < 6; i++) {
    var _div = document.createElement("div");

    _div.classList.add("stars");

    _div.classList.add("".concat(i <= numStars ? "stars_full" : "stars_empty"));
...
var initStars = function initStars(arr) {
  return arr.forEach(function (star) {
    return generateStars(star);
  });
};
...
var generateModalInfo = function generateModalInfo(e) {
  var card = e.target.closest('.model__info');
  var modalStars = modal.querySelector('.model__stars');
...
modalOpenCallmeBtns.forEach(function (btn) {
